...
<body>
    ...
    <!-- <a href="<!?php echo URLROOT; ?>/doctorRecords/infoprevious/" class="back"><i class="fa fa-backward"></i>Back</a> -->

<div class="align">
    <div>
        <h2 class="content_h1">Previous Charts - <?php echo $data['mother']->name; ?></h2>
