...
<body>
    ...
    <?php require APPROOT . '/views/inc/sidebar_doctor.php' ; ?>
        <div class="content">
            <a href="<?php echo URLROOT; ?>/doctorRecords/doctor_profile" class="back"><i class="fa fa-backward"></i>Back</a>
                <div class="container_new">
                    <h2 class="content_h2">Change Password</h2>
                    <form action="<?php echo URLROOT; ?>/doctorRecords/changepassword" method="post">
                        <div>
