    ...
    <div class="r_calendar">
        <div class="calendarcontent">
            ...
            <div class="calendar-container">
                ...
                <br>
                <h4>
                    You can select only one time slot in the next page so, <br>Please select the best date for
                    you!
                </h4>
            </div>
        </div>
            ...
            eventClick: function(info) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        const clinic_timeslot_id = info.event.extendedProps
                            .clinic_timeslot_id;
                        const url =
                            `http://localhost/MOHTHER/calendars/timeslotclinicattendeee/${nic}/${calendarId}`;
