...
<body>
    ...
    <div class="content">
        <a href="<?php echo URLROOT; ?>/clinicattendees/profile" class="back"><i class="fa fa-backward"></i>Back</a>
            <div class="container_new">
                <h2 class="content_h2">Change Password</h2>
                <form action="<?php echo URLROOT; ?>/clinicattendees/changeexpectantpassword" method="post">
                    <div>
