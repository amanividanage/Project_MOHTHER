...
<body>
    ...
    <?php require APPROOT . '/views/inc/sidebar.php' ; ?>
        <div class="content">
            ...
            <div class="align">
                <div>
                    <h2 class="content_h1">Doctor profile - <?php echo $data['doctor']->name; ?></h2>
                </div>
            ...
            <div class="mine">
                <div class="card">
                    <div class="container">
                        ...
                        <tr>
                            <td>NIC No</td>
                            <td><?php echo $data['doctor']->nic; ?></td>
                        </tr>
                        <tr>
                            <td>Phone No</td>
                            <td><?php echo $data['doctor']->phone; ?></td>
                        </tr>
                        <tr>
                            <td>E-mail</td>
                            <td><?php echo $data['doctor']->email; ?></td>
                        </tr>
                        <tr>
                            <td>Registered date</td>
                            <td><?php echo $data['doctor']->regdate; ?></td>
                        </tr>
                        </table> 
                    </div>
                </div>
            ...
            <div id="myModal" class="modal">
                ...
                <div class="container_new_modal">
                    ...
                    <form action="<?php echo URLROOT; ?>/doctors/doctorprofile/<?php echo $data['doctor']->nic; ?>" method="post">
                        <h2>Transfer doctor to another clinic</h2>
                        <p>Select a clinic to transfer the doctor </p>
                        <div>
