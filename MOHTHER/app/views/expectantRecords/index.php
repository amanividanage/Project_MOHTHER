            ...
            <table class= "">
                ...
                <?php foreach($data['newexpectantRecords'] as $newexpectantRecords):?>
                    <tr>
                        ...
                        <td><a href="<?php echo URLROOT; ?>/users/register/<?php echo $newexpectantRecords->nic; ?>" class= "updateDeliveredbutton" > Add</a></td>
        ...
        <div class= "newregdetails">
            <table>
                ...
                <?php foreach($data['expectantRecords'] as $expectantRecords):?>
                    <tr>
                    <th><a href="<?php echo URLROOT; ?>/expectantRecords/info/<?php echo $expectantRecords->nic; ?>"><?php echo $expectantRecords->nic; ?></a> </th>
